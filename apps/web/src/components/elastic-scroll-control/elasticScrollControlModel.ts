...
export type ElasticScrollMode = "idle" | "edge" | "drag";
...
const ELASTIC_SCROLL_CONTROL_DRAG_BASE_SPEED = 28;
const ELASTIC_SCROLL_CONTROL_DRAG_FAST_SPEED = 1560;
const ELASTIC_SCROLL_CONTROL_DRAG_FAST_DISTANCE = 96;
const ELASTIC_SCROLL_CONTROL_DRAG_MAX_SPEED = 2800;
...
export const getElasticScrollSpeed = (pointerDistance: number) => {
  ...
  if (pointerDistance <= ELASTIC_SCROLL_CONTROL_DRAG_FAST_DISTANCE) {
    const normalizedDistance =
      (pointerDistance - ELASTIC_SCROLL_CONTROL_DRAG_DEAD_ZONE) /
      (ELASTIC_SCROLL_CONTROL_DRAG_FAST_DISTANCE -
    ...
    return (
      ...
      (ELASTIC_SCROLL_CONTROL_DRAG_FAST_SPEED -
        ELASTIC_SCROLL_CONTROL_DRAG_BASE_SPEED) *
        easedDistance
    );
  }
  ...
  const extendedDistance = clamp(
    (pointerDistance - ELASTIC_SCROLL_CONTROL_DRAG_FAST_DISTANCE) /
